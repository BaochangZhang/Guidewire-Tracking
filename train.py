...
import inference as test  # import test.py to get mAP after each epoch
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='data/Guidewire_all_flow.yaml', help='data.yaml path')
    ...
    parser.add_argument('--name', default='all_exp_yolov5s_det_flow', help='save to project/name')
    ...
    if opt.resume and not wandb_run:  # resume an interrupted run
        ckpt = opt.resume if isinstance(opt.resume, str) else get_latest_run(Path(Path(opt.project) / opt.name))  # specified or most recent path
