...
from utils.general import check_img_size, check_requirements,non_max_suppression, non_max_suppression_detection, apply_classifier, \
    scale_coords, xyxy2xywh, set_logging, increment_path, refind
...
if __name__ == '__main__':
    ...
    parser.add_argument('--project', default='runs/mydetect/all_exp_yolov5s_det', help='save results to project/name')
    parser.add_argument('--name', default='exp_no_postprocess', help='save results to project/name')
